...
public class ParsedDateComponent {
    ...
    protected final Map<Components, Integer> knownValues = new EnumMap<Components, Integer>(Components.class);
    protected final Map<Components, Integer> impliedValues = new EnumMap<Components, Integer>(Components.class);
    ...
    public Date date(){
        ...
        Map<Components, Integer> joinInfo = new HashMap<Components, Integer>();
